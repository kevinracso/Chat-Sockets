...
# Recibir mensajes
    while True:
        try:
            ...
            elif message == "You have joined the quantum chat!":
                # avisar al usuario que puede interactuar con el chat
                print("You have joined the quantum chat")
                chat.insert(tkinter.END, message) # mantener mensajes pasados
...
client.connect((HOST, PORT)) # conectar el cliente al servidor con la tupla de host y puerto
...
client_message = tkinter.StringVar() # mensaje en el textbox
